    ...
    public class Regisseur
    {
        ...
        public DateTime Geboortedatum
        {
            ...
            set
            {
                if (value == null)
                {
                    throw new ArgumentException("Een regisseur moet een geboortedatum hebben");
                }
        ...
        public string Naam
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("Een regisseur moet een naam hebben");
                }
                _naam = value;
            }
        }
        ...
        public Regisseur(string naam, DateTime geboortedatum, string? geboortestad = "niet bekend", DateTime? sterfdatum = null)
        {
            Naam = naam;
